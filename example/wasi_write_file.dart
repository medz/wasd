...
void main() {
  ...
  final instance = WasmInstance.fromBytes(
    _buildWasiWriteFileModule(),
    imports: wasi.imports,
  );
  wasi.bindInstance(instance);

  final bytesWritten = instance.invokeI32('_start');
  final content = fs.readFileText('/zwasm.txt');

  print('bytes written: $bytesWritten');
  print('/zwasm.txt: $content');
}

Uint8List _buildWasiWriteFileModule() {
  return _buildModule(
    types: [
    ...
    imports: const [
      ...
      ('wasi_snapshot_preview1', 'fd_close', 2),
    ],
    functionTypeIndices: [3],
    memoryMinPages: 1,
    dataSegments: [
      (0, [..._i32Const(64), Opcodes.end], utf8.encode('zwasm.txt')),
      (0, [..._i32Const(128), Opcodes.end], utf8.encode('OK')),
    ],
    functionBodies: [
      [
        ..._i32Const(3),
    ...
    exports: const [
      ('_start', WasmExportKind.function, 3),
