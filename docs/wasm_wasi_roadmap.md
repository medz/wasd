...
- [ ] Concrete Preview2/Preview3 adapter modules.
  ...
  - Evidence: preview-specific host modules, owned-resource async lifecycle,
    memory-copy, and pending-copy-event wrapper tests, and versioned-host tests.
