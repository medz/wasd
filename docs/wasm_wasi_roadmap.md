...
- [ ] Concrete Preview2/Preview3 adapter modules.
  ...
  - Evidence: preview-specific host modules, owned-resource async lifecycle and
    memory-copy wrapper tests, and versioned-host tests.
