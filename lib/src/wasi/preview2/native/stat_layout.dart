...
///
/// This internal type is intentionally not exported through the package API.
final class WASIPreview2NativeStatLayout {
  const WASIPreview2NativeStatLayout._({
  ...
  static WASIPreview2NativeStatLayout? forAbi(ffi.Abi abi) {
...
const WASIPreview2NativeStatLayout _darwin64 = WASIPreview2NativeStatLayout._(
...
const WASIPreview2NativeStatLayout _linuxX64 = WASIPreview2NativeStatLayout._(
...
const WASIPreview2NativeStatLayout _androidArm64 =
    WASIPreview2NativeStatLayout._(
      minimumByteLength: 120,
      deviceOffset: 0,
      deviceWidth: _UnsignedWidth.uint64,
      inodeOffset: 8,
