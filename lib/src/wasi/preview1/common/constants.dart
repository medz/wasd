...
const int filestatSize = 64;
const int filestatDeviceOffset = 0;
const int filestatInodeOffset = 8;
const int filestatFiletypeOffset = 16;
const int filestatLinkCountOffset = 24;
const int filestatSizeOffset = 32;
const int filestatAccessTimeOffset = 40;
const int filestatModificationTimeOffset = 48;
...
const int oflagCreat = 1;
const int oflagDirectory = 2;
const int oflagExcl = 4;
const int oflagTrunc = 8;
const int oflagKnownMask = oflagCreat | oflagDirectory | oflagExcl | oflagTrunc;
